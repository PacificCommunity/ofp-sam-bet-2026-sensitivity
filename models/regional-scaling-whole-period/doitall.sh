...
# These controls persist in subsequent runs through the carried parameter file.
  ...
  1 79 290  # start bound: 240 periods back from model end, mapping to source period 53
  1 80 0  # end bound: 220 periods back from model end, mapping to source period 72
